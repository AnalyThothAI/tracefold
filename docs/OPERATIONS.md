...
`20260901_0345`. A fresh PostgreSQL 18 database applies baseline, `0341`, the
...
constraint hard cut, in order. This
...
After deployment, require Alembic head `20260901_0345`; zero rows in every cleared

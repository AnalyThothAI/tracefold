...
current-bundle / `news_review_v6` evidence, compares stable with exactly one declared `program` or
...
notification channel being reachable. The `trading_manifest_v9` manifest names

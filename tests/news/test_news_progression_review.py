...
from tracefold.news.program.progression_review import ProgressionReviewProgram
...
def test_progression_verifier_confirms_only_a_named_candidate_and_uses_its_stored_headline() -> None:
    ...
    verifier = ProgressionReviewProgram(adapter=adapter, model_binding="progression_review.primary")

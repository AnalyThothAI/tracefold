...
def test_migration_tree_is_one_root_and_head_in_the_flat_package() -> None:
    ...
    assert revisions[0].down_revision == "20260903_0356"
    assert revisions[1].down_revision == "20260903_0355"
    assert revisions[2].down_revision == "20260903_0354"
    assert revisions[3].down_revision == "20260903_0353"
    assert revisions[4].down_revision == "20260903_0352"
    assert revisions[5].down_revision == "20260902_0351"
    assert revisions[6].down_revision == "20260902_0350"
    assert revisions[7].down_revision == "20260902_0349"
    assert revisions[8].down_revision == "20260902_0348"
    assert revisions[9].down_revision == "20260901_0347"
    assert revisions[10].down_revision == "20260901_0346"
    assert revisions[11].down_revision == "20260901_0345"
    assert revisions[12].down_revision == "20260901_0344"
    assert revisions[13].down_revision == "20260901_0343"
    assert revisions[14].down_revision == "20260901_0342"
    assert revisions[15].down_revision == "20260901_0341"
    assert revisions[16].down_revision == BASELINE
    assert revisions[17].down_revision is None
...
def test_current_head_downgrade_is_irreversible() -> None:
    ...
    # `20260903_0357` deletes the unread digests from their columns and from every stored payload,
    # so it is the first refusal the walk to base meets; `20260903_0352` is still behind it.

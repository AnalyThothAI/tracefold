...
export function tradingStatusFixture(overrides: Partial<TradingStatus> = {}): TradingStatus {
  return {
    ...
    counts: {
      ...
      shadow_cohorts: {
        liquidation_continuation_shadow_v1: { completed: 1, evaluated: 2, mean_return_bps: 25 },
        liquidation_exhaustion_shadow_v1: { completed: 1, evaluated: 2, mean_return_bps: 25 },
      },
    },
    floors: {

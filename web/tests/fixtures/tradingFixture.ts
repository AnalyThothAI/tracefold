...
export function tradingIntentFixture(overrides: Partial<TradingIntent> = {}): TradingIntent {
  return {
    ...
    binding: "BINANCE_USDM",
    canonical_asset: "SOL",
    capability_entry_id: "1".repeat(64),
    capital_authorization_receipt_sha256: "2".repeat(64),
    close_leg_id: "3".repeat(64),
    economic_lifecycle_id: "4".repeat(64),
    entry_leg_id: "5".repeat(64),
    execution_binding_sha256: "6".repeat(64),
    execution_capability_snapshot_sha256: "c".repeat(64),
    execution_policy_sha256: "7".repeat(64),
    execution_phase: "PROTECTION",
    execution_state: "OPEN_PROTECTED",
    flat_verified_at_ms: null,
    instrument_id: "SOLUSDT-PERP.BINANCE",
    intent_policy_sha256: "8".repeat(64),
    ...
    policy_id: CAPITAL_POLICY_ID,
    policy_version: CAPITAL_POLICY_ID,
    protection_contract_sha256: "9".repeat(64),
    protection_leg_id: "a".repeat(64),
    provider_instrument_id: "SOLUSDT",
    protected_at_ms: TRADING_NOW_MS - 350_000,
    protected_quantity: "0.05",
    quote_contract_sha256: "b".repeat(64),
    ...
    side: "long",
    source_identity: "oi:evt-oi-sol:oi_signal_v1",
    ...
    venue_catalog_snapshot_sha256: "e".repeat(64),
    ...overrides,
  };
}

export function tradingCapabilitiesFixture(
  ...
  return {
    bindings: [
      {
        ...
        catalog_instrument_count: 2,
        catalog_snapshot_sha256: "b".repeat(64),
        compile_error: null,
        compiled_at_ms: TRADING_NOW_MS - 60_000,
        excluded_count: 1,
        included_count: 1,
        last_known_good: true,
        partition_sha256: "c".repeat(64),
        snapshot_sha256: "d".repeat(64),
      },
      {
        binding: "HYPERLIQUID_PERP",
        capability_state: "error",
        catalog_instrument_count: 1,
        compile_error: "provider_page_incomplete",
        excluded_count: 0,
        included_count: 0,
    ...
    entries: [
      ...
      {
        binding: "BINANCE_USDM",
        catalog_entry_id: "entry-unsupported",
        disposition: "excluded",
        exclusion_reason: "PROTECTION_CONTRACT_UNPROVEN",
        provider_instrument_id: "UNSUPPORTEDUSDT",
      },
    ],
    measured_at_ms: TRADING_NOW_MS,
    next_cursor: null,
...
export function tradingEvidenceFixture(overrides: Partial<TradingEvidence> = {}): TradingEvidence {
  return {
    authorities: [
      {
...
export function tradingCasesFixture(overrides: Partial<TradingCases> = {}): TradingCases {
  return {
    ...
    complete: true,
    capital_reason_counts_24h: { capital_paused: 1 },
    measured_at_ms: TRADING_NOW_MS,

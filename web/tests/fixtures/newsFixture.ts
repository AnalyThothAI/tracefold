  ...
  return {
    items: [
      ...
      },
      {
        ...
        gap_unclosed: false,
        feed_url: "https://ai.6551.io/open/news_search",
        lang: "en",
        last_error: null,
        last_http_status: 200,
        last_success_at_ms: NEWS_NOW_MS - 60_000,
        latest_entries_seen: 12,
        latest_fetch_duration_ms: 310,
        latest_fetch_error_code: null,
        latest_fetch_path: "opennews_rest",
        latest_direct_error_code: null,
        latest_fetch_finished_at_ms: NEWS_NOW_MS - 60_000,
        latest_fetch_status: "success",
        latest_items_inserted: 4,
        latest_items_updated: 0,
        latest_observations_inserted: 12,
        latest_rejection_counts: { duplicate: 8 },
        name: "OpenNews",
        memberships: ["opennews"],
        next_fetch_at_ms: NEWS_NOW_MS + 300_000,

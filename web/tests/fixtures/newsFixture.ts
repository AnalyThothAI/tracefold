...
export function newsStatusFixture(overrides: Partial<NewsStatus> = {}): NewsStatus {
  const status: NewsStatus = {
    ...
    layers: {
      ...
      push: {
        admission_policy_version: "news_push_exact_atom_admission_v1",
        delivery_24h: {
          completed: 1,
        ...
        comparison_identity_version: "news_exact_atom_identity_v1",
        ...
        payload_schema_version: "news_item_push_v2",
        pending_count: 0,
        recent_suppressions: [],
        reasons: [],
        requested: true,
        ...
        status: "ready",
        suppressed_count: 0,
        suppression_sample_complete: true,
        terminal_count: 0,
        total_count: 1,
      },
      story: {

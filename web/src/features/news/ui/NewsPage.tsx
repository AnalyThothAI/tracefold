...
import { NewsMarketItemPage } from "./market/NewsMarketItemPage";
...
type NewsPageProps = { token: string } & (
  ...
  | { itemId: string; view: "market-item" }
...
export function NewsPage(props: NewsPageProps) {
  ...
  if (props.view === "market-item")
    return <NewsMarketItemPage itemId={props.itemId} token={props.token} />;

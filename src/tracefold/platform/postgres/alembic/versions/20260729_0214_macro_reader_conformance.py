"""Hard-cut Macro module payloads to the reader conformance contract."""

from __future__ import annotations

from alembic import op

revision = "20260729_0214"
down_revision = "20260728_0213"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    raise RuntimeError("20260729_0214 is an irreversible Macro reader hard cut")

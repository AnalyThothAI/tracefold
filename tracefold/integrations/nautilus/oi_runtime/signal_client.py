...
from tracefold.trading.execution_contracts import OperatorIntentV1, TradeSignalV3

_DEFAULT_MAX_COUNT = 256
_DEFAULT_MAX_BYTES = 1_048_576

type SignalReader = Callable[[str, str, int], Sequence[TradeSignalV3]]
...
class ExecutionSignalClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._values: deque[tuple[TradeSignalV3, int]] = deque()
    ...
    def next_nowait(self) -> TradeSignalV3 | None:
        with self._lock:
            if not self._values:
                return None
